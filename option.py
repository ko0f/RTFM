...
parser.add_argument('--output-path', type=str, default='./output', help='output of AUC, final pickle and checkpoint files')
parser.add_argument('--list-test', type=str, default='list/ucf-i3d-test.list', help='list of file names for tests')
parser.add_argument('--list-train', type=str, default='list/ucf-i3d.list', help='list of file names for training')
