...
parser.add_argument('--list-test', type=str, default='list/cam2-test.csv', help='list of file names for tests')
parser.add_argument('--list-train', type=str, default='list/cam2-train.csv', help='list of file names for training')
